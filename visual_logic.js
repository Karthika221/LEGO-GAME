 ...
 * Thu Apr 04 2024 16:34:04 GMT+0530 (India Standard Time)
...
function drag1() {
  registerOnDrag(clonedred, false, [0,1,2], function() {}, function() {
    dragMove(clonedred, 'XYZ', '0zOUP]^.t}gY,`l97DA/', 'S`s(.i*q4DXlQeS.Pg.+');
...
function drag3() {
  registerOnDrag(clonedred, false, [0,1,2], function() {}, function() {
    dragMove(clonedred, 'XYZ', 'F8u|aN,(=7H1$XdhBxJY', 'RIOp`e~TXuQe;A+a3vy=');
...
function drag2() {
  registerOnDrag(clonedred, false, [0,1,2], function() {}, function() {
    dragMove(clonedred, 'XYZ', '^J7:VaAdsN;aIXud1e!E', '=r{ENwt733Xrk:jq4.kv');
...
function drag4() {
  registerOnDrag(clonedred, false, [0,1,2], function() {}, function() {
    dragMove(clonedred, 'XYZ', '?{+o^Z~OpzXZnZu`[pW9', '}]+_PYqSGxs.*oVqI#C=');
